...
public class FractionConverter : MonoBehaviour
{
    public static string Convertt(decimal pvalue,
    bool skip_rounding = false, decimal dplaces = (decimal)0.01)
    {
    ...
    public static decimal Converter(string value)
    {
        string[] dparse;
        string[] fparse;
        string whole = "0";
        ...
        (ref string line_type, bool zero_for_blank = true)
    {
        ...
        s1 = d1 == 0 ? "" : d1.ToString() + "'";
        s2 = d2 == 0 ? "" : FractionConverter.Convertt(d2) + @"""";
    ...
    {
        string sPlaces = FractionConverter.Convertt(places, true);
